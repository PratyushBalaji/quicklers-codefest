...
data = pd.read_csv('C:/Users/LENOVO/Downloads/Prostate_Cancer.csv.')


inputColumns = ['radius', 'texture', 'perimeter', 'area', 'smoothness', 'compactness', 'symmetry', 'fractal_dimension']
...
log_tuned = LogisticRegression(C=0.1, penalty = 'l2', solver = 'newton-cg')
